...
const Card = ({ res }) => {
  ...
  return (
    <div className="font-RedHat">
      ...
      <div className="md:cursor-pointer absolute top-1 right-1 p-1 bg-orange-100 my-2 mr-2 border-[1px] border-orange-950 rounded-full w-[40px] h-[40px]" onClick={handleToggleFavorite}>
        <span
          role="img"
          aria-label="corazon"
          style={{
